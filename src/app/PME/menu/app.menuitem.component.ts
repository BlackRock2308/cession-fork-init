...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public appMenu: MenuComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
    ...
    ngOnInit() {
        if (!this.appMenu.isHorizontal() && this.item.routerLink) {
            this.updateActiveStateFromRoute();
        }
    ...
    itemClick(event: Event) {
        ...
        if (this.root) {
            this.appMenu.menuHoverActive = !this.appMenu.menuHoverActive;
        }
        ...
        if (this.item.items) {
            ...
            // hide overlay menus
            if (this.appMenu.isMobile()) {
                this.appMenu.sidebarActive = false;
                this.appMenu.menuMobileActive = false;
            }
    ...
    onMouseEnter() {
        ...
        if (this.root && this.appMenu.menuHoverActive && this.appMenu.isHorizontal() && this.appMenu.isDesktop()) {
            this.menuService.onMenuStateChange(this.key);
            this.active = true;
        }
    }
