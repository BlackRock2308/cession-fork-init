...
@Component({
  selector: 'app-modifier-paiement-pme',
  templateUrl: './modifier-paiement-pme.component.html',
  styleUrls: ['./modifier-paiement-pme.component.scss']
})
export class ModifierPaiementPMEComponent implements OnInit {
